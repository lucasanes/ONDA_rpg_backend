...
export class AddAllTables1733105043669 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "sessions" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "description" character varying NOT NULL, "user_id" integer NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_3238ef96f18b355b671619111bc" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "items" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "image" character varying NOT NULL, "session_id" integer, "character_id" integer, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_ba5885359424c15ca6b9e79bcf6" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_a8ff8faee75cfd87d14da4dca2" ON "main_characters" ("character_id") `,
    );
    await queryRunner.query(
      `CREATE TABLE "status_characters" ("id" SERIAL NOT NULL, "hp" integer NOT NULL DEFAULT '0', "current_hp" integer NOT NULL DEFAULT '0', "mp" integer NOT NULL DEFAULT '0', "current_mp" integer NOT NULL DEFAULT '0', "mun" integer NOT NULL DEFAULT '0', "current_mun" integer NOT NULL DEFAULT '0', "defense" integer NOT NULL DEFAULT '0', "cd" integer NOT NULL DEFAULT '0', "character_id" integer NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "REL_77eae8bdb81927d09a727fc34f" UNIQUE ("character_id"), CONSTRAINT "PK_0aafc6284438bf5cdf36be36a9d" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_77eae8bdb81927d09a727fc34f" ON "status_characters" ("character_id") `,
    );
    await queryRunner.query(
      `CREATE TABLE "characters" ("id" SERIAL NOT NULL, "is_public" boolean NOT NULL DEFAULT false, "user_id" integer NOT NULL, "session_id" integer, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_9d731e05758f26b9315dac5e378" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_c6e648aeaab79e4213def02aba" ON "characters" ("user_id") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_bec94b9b8ecb9167cb981c7a17" ON "characters" ("session_id") `,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_bec94b9b8ecb9167cb981c7a17"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_c6e648aeaab79e4213def02aba"`,
    );
    await queryRunner.query(`DROP TABLE "characters"`);
    await queryRunner.query(
      `DROP INDEX "public"."IDX_77eae8bdb81927d09a727fc34f"`,
    );
    await queryRunner.query(`DROP TABLE "status_characters"`);
    await queryRunner.query(
      `DROP INDEX "public"."IDX_a8ff8faee75cfd87d14da4dca2"`,
    );
